...
const places = [
  {
    ...
    lat: 59.1383,    
    long: 11.3750, 
    image: "Bilder/kvik_halden.png", // Path to image for Kvik Halden
    type: "football",
  ...
  },
  {
    ...
    lat: 59.134,      
    long: 11.4568,
    image: "Bilder/tistedal.png", // Path to image for Tistedal
    type: "football",
...
,
  {
    ...
    lat: 59.118543,
    long: 11.409084,
    image: "Bilder/idd.png", // Path to image for Idd Idrettsklubb
    type: "football",
    zoomLevel: 15 // Custom zoom level
  },
  {
    ...
    lat: 59.293,
    long: 11.680,
    image: "Bilder/aremark.png", // Path to image for Aremark Fotball Klubb
    type: "football",
    zoomLevel: 15 // Custom zoom level
  },
  {
    ...
    lat: 59.124,
    long: 11.387,
    image: "Bilder/pristina.png", // Path to image for FC Pristina
    type: "football",
    zoomLevel: 16 // Custom zoom level
  },
  {
    ...
    lat: 59.120,
    long: 11.387,
    image: "Bilder/halden_volleyball.png", // Path to image for Halden Volleyball Klubb
    type: "volleyball",
    zoomLevel: 16 // Custom zoom level
  },
  {
    ...
    lat: 59.1292,
    long: 11.3528,
    image: "Bilder/hss_volleyball.png", // Path to image for HSS Volleyball
    type: "volleyball",
    zoomLevel: 15 // Custom zoom level
  }
];
...
const footballIcon = L.icon({
  iconUrl: "Bilder/ball.webp", // Specify the correct path for the football icon
  iconSize: [40, 40],
  iconAnchor: [20, 20],
  popupAnchor: [0, -20],
});
...
const volleyballIcon = L.icon({
  iconUrl: "Bilder/volleyball.jpg", // Specify the correct path for the volleyball icon
  iconSize: [40, 40],
  iconAnchor: [20, 20],
  popupAnchor: [0, -20],
});
